...
(3) build a new image for production: `docker build . -t vedph2020/cadmus-itinera-app:2.0.0-prod`. The production version is labeled like this one, with `-prod` suffix.
